...
/** @var string $title */
?>
<!-- Page header (megy a layout .app-content-header sávja alá) -->
<div class="row mb-2">
  <div class="col-sm-6">
    <h3 class="mb-0"><?= htmlspecialchars($title ?? 'Személyek') ?></h3>
  </div>
  <div class="col-sm-6">
    <ol class="breadcrumb float-sm-end">
      <li class="breadcrumb-item"><a href="<?= base_url('/') ?>">Vezérlőpult</a></li>
      <li class="breadcrumb-item active" aria-current="page">Személyek</li>
    </ol>
  </div>
</div>
...
<div class="card">
  <div class="card-header">
    <h3 class="card-title mb-0">Persons</h3>
  </div>
